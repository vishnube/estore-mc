            ...
            <div class="card-header px-lg-2 py-lg-1" style="border:none;border-top:1px solid #eee8e8;border-radius: 0;">
                <div class="row">
                    <div class="col-sm-6 col-lg-4 mt-1 m-lg-0 clearfix text-nowrap">
                        <div class="float-left" id="prty_pagination_msg"></div>
                        <div class="float-left dv-perpage" data-callback="onPartyPerpageChanged">
                            <input type="hidden" class="per-page" id="prty_per_page" value="10">
                            <div class="btn-group">
                    ...
                    <div class="col-sm-6 col-lg-3 mt-1 m-lg-0 clearfix">
                        <div class="btn-group float-lg-left float-sm-right rounded">
                            ...
                            if ($tsk_prty_pdf) {
                            ?>
                                <button type="button" class="btn bg-gradient-info btn-flat rounded-left export-PDF" data-target="#tbl_prty">
                            ...
                            if ($tsk_prty_excel) {
                            ?>
                                <button type="button" class="btn bg-gradient-danger btn-flat export-EXCEL" data-target="#tbl_prty">
                            ...
                            if ($tsk_prty_print) {
                            ?>
                                <button type="button" class="btn bg-gradient-success btn-flat rounded-right export-PRINT" data-target="#tbl_prty">
                    ...
                    <div class="col-sm-6 col-lg-2 mt-1 m-lg-0">
                        <div class="input-group float-sm-left">
                            <input type="text" id="partyQuickSearch" data-callback="" data-target="#tbl_prty" class="quick-search form-control float-right" placeholder="Quick Search">
                    ...
                    <div class="col-sm-6 col-lg-3 mt-1 m-lg-0 sr-pg-link-container">
                        <div id="prty_pagination" class="float-sm-right"></div>
                    </div>
                </div>
            </div>

            <!-- '.sr-tbl-cont' is also used to scroll to table when click on .sr-go-to-tbl -->
            <div class="sr-tbl-cont card-body table-responsive p-0" id="tbl_prty_container">
                <table class="sr-tbl-reports table table-head-fixed text-nowrap  table-hover table-striped" id="tbl_prty" data-exportTitle_1="<?= $client['clnt_print_name'] ?>" data-exportTitle_2="PARTIES LIST" data-exportTitle_3="List of parties">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="export">Address</span>
                                <div class="dv-ramp" title="Delete the column"><i class="fa fa-times-circle ramp"></i></div>
                            </th>
                            <th>
                                <span class="export">Contact</span>
                                <div class="dv-ramp" title="Delete the column"><i class="fa fa-times-circle ramp"></i></div>
                            </th>
