<div class="card card-danger mb-0" style="border-radius: .25rem .25rem 0 0;">
    <div class="card-header">
        <h4 class="card-title">
            <a data-toggle="collapse" href="#estore_category_search_form_container" role="button" aria-expanded="false" aria-controls="estore_category_search_form_container">
        ...
        <div class="card-tools">
            <button type="button" title="Add Category" id="add_estr_cat" class="btn btn-tool">
                <i class="fas fa-plus mb-2 text-white" style="font-size: 20px;"></i>
            </button>
        </div>

    </div>
    <div class="sr-collapse collapse" id="estore_category_search_form_container">
        <form class="sr-form" role="form" id="estr_cat_search_form" onsubmit="$(this).find(':submit').prop('disabled', true)">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
...
<div class="card" style="border-radius: 0px;">
    <div class="card-body">
        <div class="table-responsive" id="tbl_estr_cat_container" style="height: 400px;">
            <table class="table table-head-fixed  text-nowrap  table-hover" id="tbl_estr_cat">
                <thead>
                    <tr>
                        <th class="col-1">#</th>
