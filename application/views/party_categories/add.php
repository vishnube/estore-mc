<div class="modal fade" tabindex="-1" role="dialog" id="prty_cat_add_modal" data-backdrop="static">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form class="sr-form" role="form" id="prty_cat_add_form" onsubmit="$(this).find(':submit').prop('disabled', true)">
