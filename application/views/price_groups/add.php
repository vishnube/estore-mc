<div class="modal fade" tabindex="-1" role="dialog" id="pgp_add_modal" data-backdrop="static">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">

            <div class="modal-header bg-danger">
                <h4 class="modal-title sr-form-title has-default-value" data-default="ADD price_group" id="gridSystemModalLabel">ADD price_group</h4>
            ...
            <form class="sr-form" role="form" id="pgp_add_form" onsubmit="$(this).find(':submit').prop('disabled', true)" data-afterFormInit="afterpgpAddFormReset">
                <div class="modal-body">
                    ...
                    <div class="sr-wraper">
                        <div class="form-group">
                            ...
                            <input type="text" name="pgp_disc" id="pgp_disc" class="form-control form-control-sm" placeholder="">
                        </div>
                    </div>
