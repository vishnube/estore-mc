    ...
    <div class="col-12">
        <div class="card" style="box-shadow: none;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 mt-1 m-lg-0 clearfix">
                        <div class="btn-group float-lg-left float-sm-right rounded">
                            ...
                            if ($tsk_prd_pdf) {
                            ?>
                                <button type="button" class="btn bg-gradient-info btn-flat rounded-left export-PDF" data-target="#tbl_prd">
                            ...
                            if ($tsk_prd_excel) {
                            ?>
                                <button type="button" class="btn bg-gradient-danger btn-flat export-EXCEL" data-target="#tbl_prd">
                            ...
                            if ($tsk_prd_print) {
                            ?>
                                <button type="button" class="btn bg-gradient-success btn-flat rounded-right export-PRINT" data-target="#tbl_prd">
                    ...
                    <div class="col-sm-6 col-lg-2 mt-1 m-lg-0">
                        <div class="input-group float-sm-left">
                            <input type="text" id="productQuickSearch" data-callback="" data-target="#tbl_prd" class="quick-search form-control float-right" placeholder="Quick Search">
            ...
            <div class="sr-tbl-cont card-body table-responsive p-0" id="tbl_prd_container">
                <table class="sr-tbl-reports table table-head-fixed text-nowrap  table-hover table-striped" id="tbl_prd" data-exportTitle_1="<?= $client['clnt_print_name'] ?>" data-exportTitle_2="PRODUCTS LIST" data-exportTitle_3="List of products">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="export" data-exportStyle="">Units</span>
                                <div class="dv-ramp" title="Delete the column"><i class="fa fa-times-circle ramp"></i></div>
                            </th>
                            <!-- <th>
                                <span class="export">Rate Type</span>
                                <div class="dv-ramp" title="Delete the column"><i class="fa fa-times-circle ramp"></i></div>
                            </th>
                            <th>
                                <span class="export">Made in</span>
                                <div class="dv-ramp" title="Delete the column"><i class="fa fa-times-circle ramp"></i></div>
                            </th>
                            <th>
                                <span class="export">Production Type</span>
                                <div class="dv-ramp" title="Delete the column"><i class="fa fa-times-circle ramp"></i></div>
                            </th>
                            <th>
                                <span class="export">Dietary Type</span>
                                <div class="dv-ramp" title="Delete the column"><i class="fa fa-times-circle ramp"></i></div>
                            </th> -->
                            <th>
                                <span class="export" data-exportStyle="">Tags</span>
                                <div class="dv-ramp" title="Delete the column"><i class="fa fa-times-circle ramp"></i></div>
                            </th>
