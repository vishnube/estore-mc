<div class="modal fade" tabindex="-1" role="dialog" id="grp_add_modal" data-backdrop="static">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form class="sr-form" role="form" id="grp_add_form" onsubmit="$(this).find(':submit').prop('disabled', true)">
                <div class="modal-body">
                    <div class="sr-wraper">
                        <div class="form-group">
                            <label for="recipient-name" class="control-label sr-mdt-lbl">Name:</label>
                            <input name="grp_name" type="text" class="form-control form-control-sm">
                        </div>
                    </div>
