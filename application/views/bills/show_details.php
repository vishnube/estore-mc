                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="sr-tbl-cont card-body table-responsive p-0" id="tbl_emply_container">
                                <!-- <table class="sr-tbl-reports table table-head-fixed text-nowrap  table-hover table-striped" id="tbl_emply" > -->



                                <table class="table table-head-fixed text-nowrap  table-hover table-striped" id="tbl_fmlm">
                                    <thead>
                                        <tr>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="<?= $foot_span ?>" rowspan="6"></td>
                                            <th>KFC </th>
                                            <td><?= $bls_cess_total ?> </td>
                                        </tr>
                                        <tr>
