                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="existing-batch-tab" data-toggle="tab" href="#existing-batch" role="tab" aria-controls="existing-batch" aria-selected="true">EXISTING</a>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <!-- For sale, adding new batch is not allowed -->
                                        <a class="nav-link disabled" id="new-batch-tab" data-toggle="tab" href="#new-batch" role="tab" aria-controls="new-batch" aria-selected="false">NEW</a>
                                    </li>

                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane show active fade mt-3" id="existing-batch" role="tabpanel" aria-labelledby="existing-batch-tab">
                                        <!-- <div class="card">
                                            <div class="card-body"> -->
                                    ...
                                    <div class="tab-pane fade mt-3" id="new-batch" role="tabpanel" aria-labelledby="new-batch-tab">
                                        <?php $this->load->view('bills/product_batch_add') ?>
                                    </div>
                                </div>
                            </div>
                        </div>
