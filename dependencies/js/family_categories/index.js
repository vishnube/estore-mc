 ...
 */
function afterFamilyCategorySave(res, form, input) {
    loadFamilyCategoryOptions();
    $('#fmly_cat_add_modal').modal('hide')
 ...
 * Don't put this function in "category/add.js".
 */
$(document).on('click', '#tbl_fmly_cat .edit_fmly_cat', function () {
    var $cat_id = $(this).closest('tr').find('.cat_id').val();
    // activateTab('add');
    beforeEditFamilyCategory($cat_id);
});



$(document).on('click', '#tbl_fmly_cat .deactivate_fmly_cat', function () {
    var $cat_id = $(this).closest('tr').find('.cat_id').val();
    var $cat_name = $(this).closest('tr').find('.cat_name').val();
    var url = site_url("categories/deactivate");
    changeStatus(url, { cat_id: $cat_id }, $cat_name, INACTIVE, afterFamilyCategoryStatusChange);
});

$(document).on('click', '#tbl_fmly_cat .activate_fmly_cat', function () {
    var $cat_id = $(this).closest('tr').find('.cat_id').val();
    var $cat_name = $(this).closest('tr').find('.cat_name').val();
    var url = site_url("categories/activate");
    changeStatus(url, { cat_id: $cat_id }, $cat_name, ACTIVE, afterFamilyCategoryStatusChange);
});

function afterFamilyCategoryStatusChange() {
    loadFamilyCategories();
    loadFamilyCategoryOptions();
}
