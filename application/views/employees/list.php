            ...
            <div class="card-header px-lg-2 py-lg-1" style="border:none;border-top:1px solid #eee8e8;border-radius: 0;">
                <div class="row">
                    <div class="col-sm-6 col-lg-4 mt-1 m-lg-0 clearfix text-nowrap">
                        <div class="float-left" id="emply_pagination_msg"></div>
                        <div class="float-left dv-perpage" data-callback="onEmployeePerpageChanged">
                            <input type="hidden" class="per-page" id="emply_per_page" value="10">
                            <div class="btn-group">
                    ...
                    <div class="col-sm-6 col-lg-3 mt-1 m-lg-0 clearfix">
                        <div class="btn-group float-lg-left float-sm-right rounded">
                            ...
                            if ($tsk_emply_pdf) {
                            ?>
                                <button type="button" class="btn bg-gradient-info btn-flat rounded-left export-PDF" data-target="#tbl_emply">
                            ...
                            if ($tsk_emply_excel) {
                            ?>
                                <button type="button" class="btn bg-gradient-danger btn-flat export-EXCEL" data-target="#tbl_emply">
                            ...
                            if ($tsk_emply_print) {
                            ?>
                                <button type="button" class="btn bg-gradient-success btn-flat rounded-right export-PRINT" data-target="#tbl_emply">
                    ...
                    <div class="col-sm-6 col-lg-2 mt-1 m-lg-0">
                        <div class="input-group float-sm-left">
                            <input type="text" id="employeeQuickSearch" data-callback="" data-target="#tbl_emply" class="quick-search form-control float-right" placeholder="Quick Search">
                    ...
                    <div class="col-sm-6 col-lg-3 mt-1 m-lg-0 sr-pg-link-container">
                        <div id="emply_pagination" class="float-sm-right"></div>
                    </div>
                </div>
            </div>

            <!-- '.sr-tbl-cont' is also used to scroll to table when click on .sr-go-to-tbl -->
            <div class="sr-tbl-cont card-body table-responsive p-0" id="tbl_emply_container">
                <table class="sr-tbl-reports table table-head-fixed text-nowrap  table-hover table-striped" id="tbl_emply" data-exportTitle_1="<?= $client['clnt_print_name'] ?>" data-exportTitle_2="EMPLOYEES LIST" data-exportTitle_3="List of employees">
                    <thead>
                        <tr>
