<div class="modal fade" tabindex="-1" role="dialog" id="brnd_add_modal" data-backdrop="static">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">

            <div class="modal-header bg-danger">
                <h4 class="modal-title" id="gridSystemModalLabel">ADD BRAND</h4>
            ...
            <form class="sr-form" role="form" id="brnd_add_form" onsubmit="$(this).find(':submit').prop('disabled', true)">
                <div class="modal-body">
                    ...
                    <div class="sr-wraper">
                        <div class="form-group">
                            ...
                            <input tabindex="1" name="brnd_name" type="text" class="form-control form-control-sm">
                        </div>
                    </div>

                    <input type="hidden" name="brnd_id">
                </div>
                        ...
                        <div class="text-left">
                            <div class="form-group clearfix">
                                <div class="sr-wraper sr-check icheck-danger d-inline">
                                    ...
                                    <input type="checkbox" class="self-close no-init no-enter" checked id="brnd_add_modal_self_close">
                                    <label for="brnd_add_modal_self_close">Self Close</label>
                                </div>
                            </div>
                        </div>
